...
async function runMigration() {
  console.log("Reading create-admin-table.sql...");
  const sqlPath = path.join(__dirname, 'create-admin-table.sql');
  ...
  if (error) {
    ...
    console.log("Admins database table created and default admin seeded successfully!");
  }
}
